...
validate_ui_wiring() {
  ...
  require_token 'id="gatewayOpenAiChatForm"' "$ROUTING_VIEW_FILE"
  require_token 'id="gatewayOpenAiResponsesCreateForm"' "$ROUTING_VIEW_FILE"
  require_token 'id="gatewayOpenAiResponsesOpsForm"' "$ROUTING_VIEW_FILE"
  require_token 'id="gatewayOpenAiFilesCreateForm"' "$ROUTING_VIEW_FILE"
  require_token 'id="gatewayOpenAiFilesOpsForm"' "$ROUTING_VIEW_FILE"
  require_token 'id="selectAllGatewayOpenAiResponses"' "$ROUTING_VIEW_FILE"
  require_token 'id="bulkDeleteGatewayOpenAiResponses"' "$ROUTING_VIEW_FILE"
  require_token 'id="applyGatewayOpenAiResponsesFilter"' "$ROUTING_VIEW_FILE"
  require_token 'id="selectAllGatewayOpenAiFiles"' "$ROUTING_VIEW_FILE"
  require_token 'id="bulkDeleteGatewayOpenAiFiles"' "$ROUTING_VIEW_FILE"
  require_token 'id="applyGatewayOpenAiFilesFilter"' "$ROUTING_VIEW_FILE"
  require_token 'id="gatewayOpenAiResponsesTable"' "$ROUTING_VIEW_FILE"
  require_token 'id="gatewayOpenAiFilesTable"' "$ROUTING_VIEW_FILE"
